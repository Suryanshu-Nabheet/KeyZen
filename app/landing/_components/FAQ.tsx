...
const FAQS = [
  {
    ...
    a: (
      <>
        KeyZen is free to use with no sign-up wall, ads, or trial lock. The code is public under MIT license, so
  ...
  },
  {
    ...
    a: (
      <>
        ...
        KeyZen is created and maintained by Suryanshu Nabheet.
        {" "}
        <a
